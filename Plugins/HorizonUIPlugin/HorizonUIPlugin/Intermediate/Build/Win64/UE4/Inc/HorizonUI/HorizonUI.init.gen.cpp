...
void EmptyLinkFunctionForGeneratedCodeHorizonUI_init() {}
	...
	HORIZONUI_API UFunction* Z_Construct_UDelegateFunction_UHorizonMultiToggleButtonWidget_OnHorizonMultiToggleButtonSyncEvent__DelegateSignature();
	HORIZONUI_API UFunction* Z_Construct_UDelegateFunction_UHorizonMultiToggleButtonWidget_OnHorizonMultiToggleButtonEvent__DelegateSignature();
	...
	UPackage* Z_Construct_UPackage__Script_HorizonUI()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UHorizonMultiToggleButtonWidget_OnHorizonMultiToggleButtonSyncEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UHorizonMultiToggleButtonWidget_OnHorizonMultiToggleButtonEvent__DelegateSignature,
