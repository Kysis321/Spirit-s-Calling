...
#include "HorizonUI/Public/Widget/Components/HorizonTextBlock.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHorizonTextBlock_GetJustification_Statics::Function_MetaDataParams[] = {
		{ "Category", "HorizonPlugin|UI|TextBlock|Appearance" },
		{ "ModuleRelativePath", "Public/Widget/Components/HorizonTextBlock.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHorizonTextBlock_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHorizonTextBlock_GetJustification, "GetJustification" }, // 411512686
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHorizonTextBlock_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "Widget/Components/HorizonTextBlock.h" },
		{ "ModuleRelativePath", "Public/Widget/Components/HorizonTextBlock.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UHorizonTextBlock, 2134507833);
